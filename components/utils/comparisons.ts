...
export const diffAgainstBaseline = (cost: ScenarioCost) => {
  ...
  const baselineCostDollarAmount = getDollarValueFromCost(matchingCostFromBaseline);
  const subCostDollarAmount = getDollarValueFromCost(cost);
