        ...
        <CTabs active-item-key="costs">
          ...
          <CTabContent class="">
            <CTabPanel class="pt-3" item-key="costs">
              <!-- to do, copy any useful styles from costscard or https://github.com/jameel-institute/daedalus-web-app/pull/105/files#diff-b67c86ea7b4ea4a6d3ae7f57dac16351bf8de9df43eac351434151c5a135afb1 -->
              <!-- <CostsCard /> -->
